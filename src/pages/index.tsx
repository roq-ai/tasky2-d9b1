  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tasky2: Simplifying your daily routines with an intuitive todo list app. Prioritize, organize, and accomplish more with less stress."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Tasky2: Simplifying your daily routines with an intuitive todo list app. Prioritize, organize, and accomplish more with less stress.`}
            </Text>
            <Box
